...
header:
  ...
  overlay_filter: 0.5
  actions:
  - label: "<i class='fas fa-trophy'></i> PUK – o konkursie"
    url: "/puk/"
...
3. Uczestnikiem Konkursu może być Konstruktor lub Zespół Konstruktorów, zarówno polski, jak i zagraniczny, który:
- zgłosi swój udział do organizatora,
- dostarczy kompletny opis (dokumentację),
- przedstawi pracę konkursową na wystawie konkursowej PUK podczas Zjazdu Technicznego Krótkofalowców w Burzeninie.

4. Prace konkursowe mogą być zgłaszane w następujących kategoriach:
- A - urządzenia (urządzenia odbiorcze (RX), nadawcze (TX), nadawczo-odbiorcze (TRX), urządzenia antenowe, urządzenia pomiarowe, bloki funkcjonalne),
- B - anteny,
- C - urządzenia odwzorowywane na podstawie dostępnych powszechnie opisów,
- D - oprogramowanie.
...
6. Zgłoszenia dokonuje się poprzez wysłanie maila na adres: [puk@zjazdtechniczny.krotkofalowcy.com.pl](mailto:puk@zjazdtechniczny.krotkofalowcy.com.pl).
...
14. Prace w kategorii C będą oceniane wg następujących kryteriów:
...
17. Wszyscy uczestnicy konkursu otrzymują dyplomy i upominki. Projekty, które zajęły czołowe miejsca, otrzymują również nagrody w miarę możliwości organizatora.

18. Dodatkową nagrodę będzie można uzyskać od "publiczności" Zjazdu, gdzie każdy uczestnik zjazdu będzie dysponował jedną kartą do głosowania, na której będzie mógł zagłosować na jeden z projektów.

19. W ramach konkursu dodatkowo zostanie przyznana osobna nagroda w podkategorii ROOKIE, przyznawana uczestnikowi poniżej 18 roku życia.
